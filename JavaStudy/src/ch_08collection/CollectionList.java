...
//		students.add(13);
		...
		System.out.println(students.indexOf("김대일"));
		
		
		System.out.println(students.indexOf("김대일") != -1);
		...
		// for문으로 리스트 내데이터 처리
		// 모든 요소에 넘버링 추가 ex) 1. 이자영 2. 백민기 3. 최성복
		...
		// 리스트 복사 2
		ArrayList<String> copArrayList2 = new ArrayList<String>(students);
		System.out.println(copyList);
		
		// 리스트 복사 3
		ArrayList<String> copyArrayList3 = new ArrayList<String>();
		for(int i = 0; i < students.size(); i++) {
			copyArrayList3.add(students.get(i));
		}
		System.out.println(copyArrayList3);
