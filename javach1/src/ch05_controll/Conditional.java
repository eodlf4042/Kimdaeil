...
//			String warning = "리뷰는 12자 이상 작성하세요"; 
	   ...
	   System.out.println(subject);
		...
		if(name.length() > 0) {
		 ...
		 if(month ==0) {
			 System.out.println("열심히 배워가는중");
		 }else if(month == 1) {
			 System.out.println("db 마스터");
		 }else if(month == 2) {
			 System.out.println("자바 마스터");
		 }else if(month == 3) {
			 System.out.println("화면 구현마스터");
		 }else if(month == 4) {
			 System.out.println("jsp 마스터");
		 }else if(month == 5) {
			 System.out.println("팀부로잭트 마스터");
		 }else if(month == 6) {
